...
# Get all pairwise Siamese interactions in the support set and
# generate of list of interactions for each member of support set
'''
(0, 1)
(0, 2)
(0, 3)
...
for i in range(numsupportset):
    ...
    pairwiseinteractions[i].append(aa)  # add this interaction
    # to the set of interaction for this member

# Take 4 layer MLP transform on Max pooling of interactions
# to serve as Full Context Embedding (FCE)
maxi = Maximum()
modelinputs = []
for i in range(numsupportset):
