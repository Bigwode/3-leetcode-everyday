...
data = dataset.OmniglotNShotDataset(batch_size=bsize,
...
modelinputs.append(targetembedding)  # 六个维度每一维分别经过conv计算
...
model.fit([data.datasets_cache["train"][0], data.datasets_cache["train"][1]],
          data.datasets_cache["train"][2],
          validation_data=[[data.datasets_cache["val"][0],
                            data.datasets_cache["val"][1]],
                            data.datasets_cache["val"][2]],
          epochs=10, batch_size=32, verbose=1)

model.save('my_mn_model.h5')
